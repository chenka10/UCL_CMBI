function [starting_values,fitted_params, resnorms] = RandomZeppelinStickTortuosityFitting(startx_orig,noise_range,Avox,qhat,bvals,N)
...
for i=1:N
    try
        ...
        [parameter_hat,RESNORM,~,~]=fminunc('SSD_ZeppelinAndStickTortuosity',startx,h,Avox,bvals,qhat);
