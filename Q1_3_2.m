...
names = {'DTI','Ball And Stick','Zeppelin And Stick', 'Zeppelin And Stick (Tortuosity)'};
fit_funcs = {@FitDTI,@FitBallAndStick,@FitZeppelinAndStick,@FitZeppelinAndStickTortuosity};
compute_funcs = {@ComputeDti,@ComputeBallStick,@ComputeZeppelinStick,@ComputeZeppelinStickTortuosity};
params = cell(N,1);
resnorms = zeros(N,1);
models_res = cell(N,1);
